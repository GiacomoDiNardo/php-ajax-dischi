        ...
        <div class="container py-5">
            <div class="row row-cols-6 gap-4">
                ...
                ?>
                    ...
                    <div class="card mx-2 p-3 text-white">
                        <img src="<?php echo $disc["poster"] ?>" alt="">
                        <div class="my-card-body pt-3 text-center">
                            <h4 class="card-title"><?php echo $disc["title"] ?></h4>
                            <span class="text-secondary"><?php echo $disc["author"] ?></span><br>
                            <span class="text-secondary"><?php echo $disc["year"] ?></span>
                        </div>
                    </div>
